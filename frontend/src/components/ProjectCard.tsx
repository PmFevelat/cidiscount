      ...
      <div className="flex min-h-0 flex-1 flex-col gap-1.5 p-3">
        ...
        {project.status === "ready" && (
          <button
            ...
            className="mt-1.5 flex w-full items-center justify-center gap-1.5 rounded-lg border border-gray-200 py-1.5 text-[11px] font-medium text-gray-500 transition hover:border-[#3a2ff2] hover:text-[#3a2ff2] hover:bg-[#3a2ff2]/5"
          >
            {copied ? (
              <>
